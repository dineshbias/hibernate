package com.test.hibernate.xml.pojo.mapping.association.mto.test;
...
import com.test.hibernate.xml.pojo.mapping.association.mto.Address;
import com.test.hibernate.xml.pojo.mapping.association.mto.Employee;
...
public class ManageEmployee {
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session
					.createQuery("FROM com.test.hibernate.xml.pojo.mapping.association.mto.Employee");
	...
	public void listAddress() {
		...
		try {
			...
			System.out.println("Begin transaction....");
			Query query = session
					.createQuery(" FROM com.test.hibernate.xml.pojo.mapping.association.mto.Address");
			System.out.println("Query Created....");
