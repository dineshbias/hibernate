package com.test.hibernate.xml.pojo.mapping.association.oto.nfka.test;
...
import com.test.hibernate.xml.pojo.mapping.association.oto.nfka.Address;
import com.test.hibernate.xml.pojo.mapping.association.oto.nfka.Employee;
...
public class ManageEmployee {
	...
	public static void main(String... args) throws IOException {
		...
		System.out.println("\n" + ManageEmployee.class + " Testing one to one association mapping without unique froeign key association...");
		testEmployeeDB();
		factory.close();
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session
					.createQuery("FROM com.test.hibernate.xml.pojo.mapping.association.oto.nfka.Employee");
	...
	public void listAddress() {
		...
		try {
			...
			System.out.println("Begin transaction....");
			Query query = session
					.createQuery(" FROM com.test.hibernate.xml.pojo.mapping.association.oto.nfka.Address");
			System.out.println("Query Created....");
			List<Address> addresses = query.list();
			System.out.println(this.getClass() + " listAddress.... "
					+ addresses.size());
	...
	public Address addAddress(Address address,Employee employee) {
		...
		try {
			...
			System.out.println("Session saved... " + addressId);
			tx.commit();
	...
	public void deleteAddress(int id) {
		...
		Session session = factory.openSession();
		System.out.println("\n" + this.getClass() + " deleteAddress.... " + id
				+ " " + session);
		Transaction tx = null;
		...
		try {
			...
			System.out.println(this.getClass() + " deleteAddress.... "
					+ address);
