package com.test.hibernate.xml.pojo.mapping.association.oto.ufka.test;
...
import com.test.hibernate.xml.pojo.mapping.association.oto.ufka.Address;
import com.test.hibernate.xml.pojo.mapping.association.oto.ufka.Employee;
...
public class ManageEmployee {
	...
	public static void main(String... args) throws IOException {
		...
		System.out.println("\n" + ManageEmployee.class + " Testing one to one association mapping using unique froeign key association...");
		testEmployeeDB();
		factory.close();
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session
					.createQuery("FROM com.test.hibernate.xml.pojo.mapping.association.oto.ufka.Employee");
	...
	public void listAddress() {
		...
		try {
			...
			System.out.println("Begin transaction....");
			Query query = session
					.createQuery(" FROM com.test.hibernate.xml.pojo.mapping.association.oto.ufka.Address");
			System.out.println("Query Created....");
