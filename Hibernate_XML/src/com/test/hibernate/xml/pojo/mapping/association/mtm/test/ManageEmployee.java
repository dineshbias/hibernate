package com.test.hibernate.xml.pojo.mapping.association.mtm.test;
...
import com.test.hibernate.xml.pojo.mapping.association.mtm.Certificate;
import com.test.hibernate.xml.pojo.mapping.association.mtm.Employee;
...
public class ManageEmployee {
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session
					.createQuery("FROM com.test.hibernate.xml.pojo.mapping.association.mtm.Employee");
	...
	public void listCertificates() {
		...
		try {
			...
			System.out.println("Begin transaction....");
			Query query = session
					.createQuery(" FROM com.test.hibernate.xml.pojo.mapping.association.mtm.Certificate");
			System.out.println("Query Created....");
