...
public class TestSessionScopedInterceptor {

	private static SessionFactory factory;

	static {
		System.out.println(Thread.currentThread() + " loading hibernate configs...");

		Configuration config = new Configuration().configure("hibernateConfBatch.cfg.xml");
		factory = config.buildSessionFactory();

		System.out.println(Thread.currentThread() + " loaded hibernate configs...");
	}
	...
	public static void testInterceptors() {
		System.out.println(Thread.currentThread() + " testInterceptors started...");

		System.out.println(Thread.currentThread() + " Open session ...");
		SessionBuilder builder = factory.withOptions().interceptor(new LoggerInterceptor());
		...
		try {
			...
			System.out.println(Thread.currentThread() + " Commit Transaction ...");
			tx.commit();
		}
		...
		System.out.println(Thread.currentThread() + " testInterceptors exit...");
	}

	public static void testNoInterceptors() {
		System.out.println("\n" + "\n");
		System.out.println(Thread.currentThread() + " testNoInterceptors started...");
		...
		System.out.println(Thread.currentThread() + " testNoInterceptors exit...");
	}
}
