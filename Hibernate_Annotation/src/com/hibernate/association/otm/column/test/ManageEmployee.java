package com.hibernate.association.otm.column.test;
...
import com.hibernate.association.otm.column.Certificate;
import com.hibernate.association.otm.column.Employee;
...
public class ManageEmployee {
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session.createQuery("FROM com.hibernate.association.otm.column.Employee");
			System.out
	...
	public void listCertificates() {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Begin transaction....");
			Query query = session.createQuery(" FROM com.hibernate.association.otm.column.Certificate");
			System.out.println(
