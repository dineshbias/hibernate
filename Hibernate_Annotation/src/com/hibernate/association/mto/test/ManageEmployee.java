package com.hibernate.association.mto.test;
...
import com.hibernate.association.mto.Address;
import com.hibernate.association.mto.Employee;
...
public class ManageEmployee {
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session.createQuery("FROM com.hibernate.association.mto.Employee");
	...
	public void listAddress() {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Begin transaction....");
			Query query = session.createQuery(" FROM com.hibernate.association.mto.Address");
			System.out.println("Query Created....");
