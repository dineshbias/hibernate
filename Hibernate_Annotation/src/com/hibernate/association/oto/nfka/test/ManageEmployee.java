package com.hibernate.association.oto.nfka.test;
...
import com.hibernate.association.oto.nfka.Address;
import com.hibernate.association.oto.nfka.Employee;
...
public class ManageEmployee {
	...
	public static void main(String... args) throws IOException {
		...
		System.out.println("\n" + ManageEmployee.class
				+ " Testing one to one association mapping without unique froeign key association...");
		testEmployeeDB();
		factory.close();
	...
	public void listEmployees() {
		...
		try {
			...
			Query query = session.createQuery("FROM com.test.hibernate.xml.pojo.mapping.association.oto.nfka.Employee");
	...
	public void listAddress() {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Begin transaction....");
			Query query = session.createQuery(" FROM com.test.hibernate.xml.pojo.mapping.association.oto.nfka.Address");
			System.out.println("Query Created....");
